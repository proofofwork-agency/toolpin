...
| MCPB bundles without declared integrity | Trust and policy checks can require `fileSha256`. | Presence check only; ToolPin does not download and hash the bundle. |
