  ...
  themeConfig: {
    navbar: {
      ...
      items: [
        ...
        { href: "https://github.com/proofofwork-agency/toolpin", label: "GitHub", position: "right" },
      ],
    },
    footer: {
      style: "dark",
      links: [
        ...
        },
        {
          title: "Project",
          items: [
            { label: "GitHub", href: "https://github.com/proofofwork-agency/toolpin" },
            { label: "Security", href: "https://github.com/proofofwork-agency/toolpin/security" },
          ],
        },
      ],
